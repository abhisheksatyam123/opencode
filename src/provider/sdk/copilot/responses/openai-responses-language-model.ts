...
import type { OpenAIConfig } from "@/provider/sdk/copilot/responses/openai-config"
import { openaiFailedResponseHandler } from "@/provider/sdk/copilot/responses/openai-error"
import {
  codeInterpreterInputSchema,
  codeInterpreterOutputSchema,
} from "@/provider/sdk/copilot/responses/tool/code-interpreter"
import { fileSearchOutputSchema } from "@/provider/sdk/copilot/responses/tool/file-search"
import { imageGenerationOutputSchema } from "@/provider/sdk/copilot/responses/tool/image-generation"
...
import type { OpenAIResponsesModelId } from "@/provider/sdk/copilot/responses/openai-responses-settings"
import { localShellInputSchema } from "@/provider/sdk/copilot/responses/tool/local-shell"
...
function getResponsesModelConfig(modelId: string): ResponsesModelConfig {
  ...
  // Chat-optimized models are non-reasoning
...
// AI SDK 6 migration: use optional here instead of nullish.
