...
function union(ast: SchemaAST.Union): z.ZodTypeAny {
  ...
  const discriminator = (ast as any).annotations?.discriminator // as any: SchemaAST.Union.annotations is not in the public Effect type; accessed via internal AST shape
  if (discriminator) {
