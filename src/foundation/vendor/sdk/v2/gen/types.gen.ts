...
export type EventTodoUpdated = {
  ...
  properties: {
    ...
    tree?: Array<Todo>
    /** Raw text of ## Context section */
    context?: string
    /** Learnings grouped by agent name */
    learnings_by_agent?: Record<string, Array<string>>
    /** Open questions lines */
    open_questions?: Array<string>
    /** Active working memory key→value */
    ...
    /** Current task path path bound to this session */
    task_path?: string
    /** Current task path sections, in note order, for one-to-one UI rendering */
    sections?: Array<TodoSection>
    /** All todo IDs attached to this session */
    attached_todo_ids?: Array<string>
    /** Map of todo ID to label for all attached todos */
...
export type Config = {
  ...
  compaction?: {
    ...
    prune?: boolean
    /**
     * Token count at which auto-compaction fires for all agents, regardless of model context window size. Default: 150000.
     */
...
export type ContextComponentStats = {
  name: string
  tokens: number
  pct: number
  detail?: string
...
export type ContextWindowStats = {
  ...
  components: Array<ContextComponentStats>
  tools: Array<ContextToolStats>
  callCount: number
...
export type SessionTokenStats = {
  ...
  timeline: Array<TurnStats>
  llmCalls: Array<LLMCallStats>
...
export type SessionTodoResponses = {
  /**
   * Todo list with tree and section snapshots
   */
  200: {
    todos: Array<Todo>
    tree?: Array<Todo>
