...
type NpmEntryPoint = EntryPoint
type NpmInterface = Interface
const NpmInstallFailedError = InstallFailedError
const NpmService = Service
const NpmSanitize = sanitize
const NpmLayer = layer
const NpmDefaultLayer = defaultLayer
const NpmInstall = install
const NpmAdd = add
const NpmWhich = which

export namespace Npm {
  export type EntryPoint = NpmEntryPoint
  export type Interface = NpmInterface
  export const InstallFailedError = NpmInstallFailedError
  export const Service = NpmService
  export const sanitize = NpmSanitize
  export const layer = NpmLayer
  export const defaultLayer = NpmDefaultLayer
  export const install = NpmInstall
  export const add = NpmAdd
  export const which = NpmWhich
}
