...
type AppProcessRunOptions = RunOptions
type AppProcessRunStreamOptions = RunStreamOptions
type AppProcessRunResult = RunResult
type AppProcessInterface = Interface
const AppProcessErrorValue = AppProcessError
const AppProcessService = Service
const AppProcessRequireSuccess = requireSuccess
const AppProcessRequireExitIn = requireExitIn
const AppProcessLayer = layer
const AppProcessDefaultLayer = defaultLayer

export namespace AppProcess {
  export type RunOptions = AppProcessRunOptions
  export type RunStreamOptions = AppProcessRunStreamOptions
  export type RunResult = AppProcessRunResult
  export type Interface = AppProcessInterface
  export const AppProcessError = AppProcessErrorValue
  export const Service = AppProcessService
  export const requireSuccess = AppProcessRequireSuccess
  export const requireExitIn = AppProcessRequireExitIn
  export const layer = AppProcessLayer
  export const defaultLayer = AppProcessDefaultLayer
}
