...
const CrossSpawnSpawnerMake = make
const CrossSpawnSpawnerLayer = layer
const CrossSpawnSpawnerDefaultLayer = defaultLayer

export namespace CrossSpawnSpawner {
  export const make = CrossSpawnSpawnerMake
  export const layer = CrossSpawnSpawnerLayer
  export const defaultLayer = CrossSpawnSpawnerDefaultLayer
}
