...
import type {
  ...
  FileDefinitionErrors,
  FileDefinitionResponses,
  FileListResponses,
  FilePartInput,
  FilePartSource,
  FileReadResponses,
...
export class App extends HeyApiClient {
   ...
   *
   * Deprecated route. Todo+notes-centric mode no longer exposes runtime skills.
   */
...
export class Session2 extends HeyApiClient {
   ...
   *
   * Aggregate token usage and costs across a root session and all direct child sessions.
   */
  public stats<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<SessionStatsResponses, SessionStatsErrors, ThrowOnError>({
   ...
   * Initialize session
   *
   * Analyze the current application and bootstrap project notes for notes-centric workflows.
   */
...
export class Permission extends HeyApiClient {
   ...
   *
   * Get all pending permission requests waiting for user approval.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Approve or reject a pending permission request from the AI assistant.
   */
...
export class Theme extends HeyApiClient {
   ...
   * List UI themes
   *
   * List TUI-compatible themes available to the UI, including custom vault etc/themes entries.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).get<ThemeListResponses, unknown, ThrowOnError>({
      url: "/theme",
      ...options,
      ...params,
    })
...
export class File extends HeyApiClient {
   ...
   * Write file
   *
   * Write content to an existing workspace text file.
   */
   ...
   *
   * Resolve a source location to definition locations using an available LSP server.
   */
  public definition<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<FileDefinitionResponses, FileDefinitionErrors, ThrowOnError>({
      url: "/file/definition",
      ...options,
      ...params,
    })
