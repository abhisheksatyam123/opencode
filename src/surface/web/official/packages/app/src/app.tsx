...
function AppShellProviders(props: ParentProps<{ embedded?: boolean }>) {
  return (
    <SettingsProvider>
      <PermissionProvider>
        <LayoutProvider>
...
function RouterRoot(props: ParentProps<{ appChildren?: JSX.Element }>) {
  ...
  const embedded = createMemo(() => new URLSearchParams(location.search).get("embed") === "chat")
  return (
    <AppShellProviders embedded={embedded()}>
      <Show when={!embedded()}>{props.appChildren}</Show>
      {props.children}
    </AppShellProviders>
  )
}
