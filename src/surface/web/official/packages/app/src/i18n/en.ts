export const dict = {
  ...
  "command.model.variant.choose": "Choose thinking effort",
  "command.model.variant.choose.description": "Select the effort level for the current model",
  ...
  "palette.search.placeholder": "Search files, commands, sessions, and symbols",
  "palette.empty": "No results found",
  "palette.action.relationships": "Relations",
  ...
  "prompt.action.readOnly": "Read-only access",
  ...
  "prompt.toast.readOnly.title": "Read-only access",
  "prompt.toast.readOnly.description": "Use a write token to send messages or run terminal commands.",
