      ...
      >
        ...
        >
          ...
          <div class="flex items-center gap-1 shrink-0">
            <div id="opencode-titlebar-left" class="flex items-center gap-2 min-w-0 px-1 shrink-0" />
            <Show when={!params.id}>
              <TooltipKeybind
        ...
        >
          ...
          <Show when={params.id}>
            <div class="xl:hidden shrink-0 flex items-center justify-center w-10">
              <IconButton
                icon="layout-right"
                variant="ghost"
                class="titlebar-icon rounded-md"
                onClick={layout.mobileNav.toggle}
                aria-label="Open panel navigation"
                aria-expanded={layout.mobileNav.opened()}
              />
            </div>
          </Show>
          <Show when={windows()}>
