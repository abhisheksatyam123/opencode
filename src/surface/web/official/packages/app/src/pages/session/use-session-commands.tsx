...
export const useSessionCommands = (actions: SessionCommandContext) => {
  ...
  const showAllFiles = () => {
    ...
    if (layout.fileTree.tab() === "all") return
  ...
  const readOnly = () => server.authRole() === "read"
  ...
  const chooseModel = () => {
    void import("@/components/dialog-select-model-dialog").then((x) => {
  ...
  const modelCmds = () => [
    ...
    modelCommand({
      ...
      slash: "effort",
      disabled: local.model.variant.list().length === 0,
