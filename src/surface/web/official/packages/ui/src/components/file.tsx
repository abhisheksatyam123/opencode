...
const codeMetrics = {
  // Keep this literal instead of spreading DEFAULT_VIRTUAL_FILE_METRICS at module
  // initialization. The optimized official Web UI bundle can otherwise hit a TDZ
  // around the imported default metrics symbol in the shared ui-components chunk.
  lineHeight: 24,
