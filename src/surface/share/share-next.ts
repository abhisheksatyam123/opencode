...
import { Account } from "@/init/account"
import { Bus } from "@/bus"
...
import { SessionShareTable } from "@/surface/share/share.sql"

export namespace ShareNext {
  const log = Log.create({ service: "share-next" })
  // flag-followup-1: route through Flag.OPENCODE_DISABLE_SHARE so
  // env-var consumers are discoverable in one place.
