...
import { createPluginKeybind } from "@/surface/cli/cmd/tui/context/plugin-keybinds"
import type { useKV } from "@/surface/cli/cmd/tui/context/kv"
...
import { DialogSelect, type DialogSelectOption as SelectOption } from "@/surface/cli/cmd/tui/ui/dialog-select"
import { Prompt } from "@/surface/cli/cmd/tui/component/prompt"
import { Slot as HostSlot } from "@/surface/cli/cmd/tui/plugin/slots"
import type { useToast } from "@/surface/cli/cmd/tui/ui/toast"
...
function stateApi(sync: ReturnType<typeof useSync>): TuiPluginApi["state"] {
  return {
    ...
    session: {
      ...
      workspace_todos() {
        return sync.data.workspace_todos
      },
      attached_todo_ids(sessionID) {
        return sync.data.attached_todo_ids[sessionID] ?? []
      },
      attached_todo_labels(sessionID) {
        return sync.data.attached_todo_labels[sessionID] ?? {}
      },
    },
    part(messageID) {
