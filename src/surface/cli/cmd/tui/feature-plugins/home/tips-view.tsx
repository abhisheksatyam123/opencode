...
const TIPS = [
  ...
  "Use the {highlight}Stats{/highlight} and {highlight}Files{/highlight} tabs for context usage and modified files",
  ...
  "Add {highlight}.md{/highlight} files to {highlight}<vault>/etc/command/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Edit {highlight}src/agent/prompts/<name>.md{/highlight} to adjust built-in agent prompt cards",
  ...
  "Create {highlight}.ts{/highlight} files in {highlight}<vault>/etc/tools/{/highlight} to define new LLM tools",
  "Tool definitions can invoke scripts written in Python, Go, etc",
  "Add {highlight}.ts{/highlight} files to {highlight}<vault>/etc/plugin/{/highlight} for event hooks",
  ...
  "Create JSON theme files in {highlight}<vault>/etc/themes/{/highlight} directory",
  ...
  "Commit your project's {highlight}notes{/highlight} updates to Git for team sharing",
